---
title: XQuartz 2.8.5_beta4

version: 2.8.5_beta4
date: 2023.01.09
filename: XQuartz-2.8.5_beta4.pkg
download_url: https://github.com/XQuartz/XQuartz/releases/download/XQuartz-2.8.5_beta4/XQuartz-2.8.5_beta4.pkg
required_os_version: 10.9
status: prerelease
---

### Changes in {{ page.version }} ###
  * All changes in [2.8.5_beta3](XQuartz-2.8.5_beta3.html) plus:
  * Fixed an issue when resizing motif applications ([#309](https://github.com/XQuartz/XQuartz/issues/309))
...
additional patches available from [XQuartz Github](https://github.com/XQuartz/XQuartz/releases/tag/XQuartz-{{ page.version }}).
  ...
  * xquartz/xserver XQuartz-2.8.5_beta4 (c022766a10974366fa2aafb6a06d4269778490f4)
