...
### Changes in {{ page.version }} ###
  ...
  * lib:
    ...
    * [libxcb 1.9.1](https://lists.x.org/archives/xorg-announce/2013-May/002230.html)
      ...
      * Fixes a deadlock in wine ([#696](https://github.com/XQuartz/xquartz-old-tickets/blob/master/ticket/696.md))
  ...
  * server:
    ...
    * [xorg-server 1.14.4](https://lists.x.org/archives/xorg/2013-November/056147.html) plus [other patches](https://github.com/XQuartz/xorg-server/commits/XQuartz-2.7.5)
      * Don't force discreet graphics ([#654](https://github.com/XQuartz/xquartz-old-tickets/blob/master/ticket/654.md))
      * Removed support for 15bit visuals which no longer work in Mountain Lion ([#633](https://github.com/XQuartz/xquartz-old-tickets/blob/master/ticket/633.md))
      * Fix a rendering regression seen in pixman by reverting to old rendering code paths ([#525](https://github.com/XQuartz/xquartz-old-tickets/blob/master/ticket/525.md))
      * Fix a crash with gimp and other apps ([#591](https://github.com/XQuartz/xquartz-old-tickets/blob/master/ticket/591.md))
