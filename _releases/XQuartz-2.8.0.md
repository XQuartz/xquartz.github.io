...
version: 2.8.0
date: 2021.03.21
filename: XQuartz-2.8.0.dmg
download_url: https://github.com/XQuartz/XQuartz/releases/download/XQuartz-2.8.0/XQuartz-2.8.0.dmg
required_os_version: 10.9
status: release
emphasis: First release with native Apple Silicon support
---
...
additional patches available from [XQuartz Github](https://github.com/XQuartz/XQuartz/releases/tag/XQuartz-{{ page.version }}).
  ...
  * xquartz/xserver XQuartz-2.8.0 (890235707154f32a8bf9a65643cdb41c45573fe6)
