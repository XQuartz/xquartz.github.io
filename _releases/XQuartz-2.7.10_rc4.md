---
title: XQuartz 2.7.10_rc4

version: 2.7.10_rc4
date: 2016.09.27
filename: XQuartz-2.7.10_rc4.dmg
download_url: https://github.com/XQuartz/XQuartz/releases/download/XQuartz-2.7.10_rc4/XQuartz-2.7.10_rc4.dmg
...
### Changes in {{ page.version }} ###
  ...
  * server:
    * [xorg-server 1.18.4](https://lists.x.org/archives/xorg-announce/2016-July/002699.html) plus [other patches](https://github.com/XQuartz/xorg-server/commits/XQuartz-2.7.10_rc4)
