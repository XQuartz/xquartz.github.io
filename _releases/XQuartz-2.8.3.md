...
version: 2.8.3
date: 2022.12.09
filename: XQuartz-2.8.3.pkg
download_url: https://github.com/XQuartz/XQuartz/releases/download/XQuartz-2.8.3/XQuartz-2.8.3.pkg
...
### Changes in {{ page.version }} ###
  ...
  * Updated libXft to latest version to address an issue with text in Motif apps([#301](https://github.com/XQuartz/XQuartz/issues/301))
...
additional patches available from [XQuartz Github](https://github.com/XQuartz/XQuartz/releases/tag/XQuartz-{{ page.version }}).
  ...
  * xquartz/xserver XQuartz-2.8.3 (d6409dc3eb4f89ec259bfbfe98af81846ec645e6)
